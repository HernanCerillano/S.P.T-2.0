...
public class PresupuestoDetalleResponse {
    ...
    public PresupuestoDetalleResponse() {
    }

    public PresupuestoDetalleResponse(Long idDetallePresupuesto, Long idPresupuesto, TipoItemDetalle tipoItem, Long idPieza, Long idServicio, String descripcionItem, Integer cantidad, BigDecimal precioUnitario, BigDecimal subtotal) {
